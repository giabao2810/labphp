...
<html lang="vi">
    <head>
        <meta charset="utf-8">
        <meta name="author" content="DuongGiaBao" />
        ...
        <div id="wrapper">
            ...
            <?php
                ...
                if(isset($_SESSION['user'])!="")
                {
                    ...
                    echo "<h2>Bạn chưa đăng nhập <a href='./../login.php'> Login</a>-<a
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="" class="text-decoration-none">
                    <span class="h1 text-uppercase text-primary bg-dark px-2">Until</span>
